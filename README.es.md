...
<p align="center">
  ...
  <a href="README.md"><img src="https://img.shields.io/badge/Lang-Indonesia-blue?style=for-the-badge" alt="Indonesia"></a>
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/Lang-中文-red?style=for-the-badge" alt="中文"></a>
  <a href="README.ur-pk.md"><img src="https://img.shields.io/badge/Lang-اردو-green?style=for-the-badge" alt="اردو"></a>
  <a href="README.es.md"><img src="https://img.shields.io/badge/Lang-Español-orange?style=for-the-badge" alt="Español"></a>
</p>

> **⚠️ BIFURCACIÓN PERSONALIZADA PARA LAM-CYBERLAB**
>
> Este repositorio es una versión muy modificada de Hermes Agent por **Ahlfs**. Está diseñado específicamente para ser totalmente compatible como el motor de inteligencia backend para **[LAM-Cyberlab](https://github.com/ahlfs/LAM-Cyberlab)**. Consulte la sección [Second Brain Edition](#-second-brain-edition-bifurcación-personalizada) a continuación para obtener detalles sobre las funciones personalizadas.
...
## 🧠 Second Brain Edition (Bifurcación Personalizada)

Esta es una bifurcación (fork) personalizada de Hermes Agent **modificada y mantenida por Ahlfs**, que presenta una tubería autónoma de **Second Brain (Segundo Cerebro)** y copias de seguridad de configuración automatizadas en GitHub.

### Características
1. **Tubería Automatizada de Second Brain**
   - **Transcripción de Audio**: Coloca un `.mp3` en `01-Audio` y Hermes lo transcribirá automáticamente usando Whisper.
   - **Análisis de Documentos**: Analiza `.pdf` y realiza OCR en imágenes colocadas en `02-Documents`.
   - **Generación de Wiki**: Sintetiza transcripciones y documentos en archivos markdown interconectados estilo Wikipedia en `04-Wiki`.
   - **Copia de seguridad en Git**: Confirma (commit) y empuja (push) automáticamente los nuevos conocimientos a un repositorio privado de GitHub.
   - **Cascada Completa de Limpieza de Fuentes**: Elimina de forma segura los archivos fuente sin procesar (`.mp3`, `.pdf`, etc.) de `01-Audio` y `02-Documents` *solo después* de que el conocimiento final se haya respaldado con éxito en GitHub, manteniendo su bóveda ligera.
2. **Copia de Seguridad de Configuración Automatizada**
   - Realiza copias de seguridad de sus configuraciones en `~/.hermes`, habilidades personalizadas y memorias a un repositorio privado de GitHub separado a través de una tarea cron programada (predeterminado: cada 24 horas).
3. **Enrutador Dinámico de Enjambre (Enrutamiento Basado en Intención)**
   - Intercepta y enruta automáticamente los mensajes entrantes al sub-agente especialista más capaz (`builder`, `researcher`, `writer`).
   - Utiliza la clasificación de palabras clave de latencia cero para inferir la intención del usuario, brindando una experiencia sin fricciones sin necesidad de cambiar el perfil manualmente.
4. **Integración Nativa con LAM-Cyberlab**
   - **Transmisión en Tiempo Real**: Soporte completo para la transmisión progresiva de tokens a través de SSE/WebSockets (`stream_events.py`), lo que lo convierte en un backend de inteligencia plug-and-play sin fricciones para la interfaz de LAM-Cyberlab.
   - **Aprendizaje de Bucle Cerrado**: Hace sinergia perfectamente con el generador nativo de habilidades de autorreparación (Self-Healing Skill Generator). Al enfrentarse a tareas complejas desde la interfaz de usuario de Cyberlab, el agente puede escribir, probar y guardar de manera autónoma sus propias habilidades nuevas `.md` para su uso futuro.
