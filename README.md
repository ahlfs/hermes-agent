...
The Second Brain pipeline requires `ffmpeg` (for audio transcription) and `tesseract-ocr` (for image/document text extraction). Run the command appropriate for your system:
